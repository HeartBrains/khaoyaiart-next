...
const BKKK_BASE_URL = (process.env.BKKK_BASE_URL ?? 'https://next.bkkapp.com/bkkk').replace(/\/$/, '');
const KYAF_BASE_URL = (process.env.KYAF_BASE_URL ?? 'https://next.bkkapp.com/kyaf').replace(/\/$/, '');
