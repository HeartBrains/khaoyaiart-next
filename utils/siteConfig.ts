...
export const siteConfig = {
  ...
  emptyStates: {
    ...
    noContent: { th: 'ยังไม่มีเนื้อหา', en: 'No content available' },
    noResults: { th: 'ไม่พบผลลัพธ์', en: 'No results found' },
    noCurrentExhibitions: { th: 'ไม่มีนิทรรศการในขณะนี้', en: 'No current exhibitions' },
    noUpcomingExhibitions: { th: 'ไม่มีนิทรรศการที่กำลังจะมาถึง', en: 'No upcoming exhibitions' },
    noPastExhibitions: { th: 'ไม่มีนิทรรศการที่ผ่านมา', en: 'No past exhibitions' },
